;(function (window) {
  ...
  let texts = ['MERA BETA💕', 'KHADER', 'TU HAMESHA', 'UPER DEKHTA','NE ASMAAN KU', 'AAJ WAHI SE', 'TUJHE ', 'DEKH RAHI HU',  'BOHOT NAAZ ', 'HU KI MERA', 'BETA BADA ', 'HOGAYA 💞','ZIMMEDARI','UTHA RAHA HAI','BHAAN KI','MUJH MALUM','TU KYA SOCH','RAHA HAI','TERI GALTI','NAHI HAI','MY TERE SE','GUSSA NEHU','MY TERE SAAT','HAMESHA HU','RONA NAI','AGAR TU ROYA','MY YAHA ROTU','MERI ROOH TU','NOORIE KA','BETA TU','HIMMAT SE','HANA TU','MERA',' KHOON TU','KOI TUJHE','SUNE YA NA ','SUNE','MY HAMESHA','SUNTU HATU','TERE SAAT','MY HU NE','MUJH BOLKE','DIL HALKA ','KARLE','AKELA MAT SAMJH','TU JO BHI','KARNA CHAHTA ','HAI,MY','TERE SATH HU','AB HASS NA','MERI JAAN','HAPPY','BIRTHDAY 🎂', 'DAY', 'KHADERAA', 'I LOVE YOU❤️','TERI AMMI','NOORIE🌟' ]
